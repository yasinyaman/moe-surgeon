# Architecture: one directory owns the vLLM dependency

Why this is a separate package, the layering rule and the seam table that
enforce it, and what a vLLM upgrade costs to evaluate.
